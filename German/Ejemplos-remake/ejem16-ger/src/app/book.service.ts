...
export class BookService {
  ...
  getBook(id: number) {
    ...
    //return this.books.find((book) => book.id === +id); //Ese + que le ponia al id era para parsearlo de string a number, yo directamente le puse un Number.parseInt() en la pantalla anterior para ya pasarle un int
  }
}
